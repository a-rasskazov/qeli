...
Клиент дополнительно перестал принимать пустой plaintext за ответ — со старым сервером это
единственная защита, и «пусто — это не ответ» верно независимо от того, кто на той стороне.
